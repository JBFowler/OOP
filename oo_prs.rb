# PRS is a game between 2 players.  Both players pick a hand of either "paper", "rock" or "scissors".  Then, the
# two hands are compared and it's either a tie (if hands are the same) or p > r, r > s, and s > p.
